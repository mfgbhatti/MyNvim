...
-- NOTE: set this to `false` if your terminal/font doesn't have Nerd Font glyphs
-- (worth double-checking if you're mainly using a mobile terminal app)
vim.g.have_nerd_font = true

vim.o.number = false -- using mobile
vim.o.mouse = "a"
